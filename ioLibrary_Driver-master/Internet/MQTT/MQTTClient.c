...
int MQTTConnect(MQTTClient* c, MQTTPacket_connectData* options)
{
    ...
    int len = 0;
	debug_uart_transmit_string_mqtt("Connect Function Started\n");
    ...
    if (options == 0)
	{
		...
		debug_uart_transmit_string_mqtt("Options == 0 \n");
	}
	...
	{	
		debug_uart_transmit_string_mqtt("SendPack != Success\n");
        goto exit; // there was a problem
	}
...
exit:
    if (rc == SUCCESSS)
	{
		debug_uart_transmit_string_mqtt("rc == Success\n");
        c->isconnected = 1;
	}
